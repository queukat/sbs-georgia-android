...
@Composable
fun workflowStatusLabel(status: MonthlyWorkflowStatus): String = stringResource(workflowStatusLabelRes(status))

@StringRes
fun workflowStatusLabelRes(status: MonthlyWorkflowStatus): Int = when (status) {
...
@Composable
fun fxRateSourceLabel(source: FxRateSource): String = stringResource(fxRateSourceLabelRes(source))

@StringRes
fun fxRateSourceLabelRes(source: FxRateSource): Int = when (source) {
