...
constructor() {
    fun canParse(extractedText: String): Boolean {
        ...
        return registryMarkers.any { it in normalized } ||
            registryFieldMatchCount(normalized) >= 2
    }

    fun parse(sourceFileName: String, sourceFingerprint: String, extractedText: String): OnboardingImportPreview {
        ...
        return OnboardingImportPreview(
            ...
            legalAddress =
            lines.extractRegistryAddressField(
