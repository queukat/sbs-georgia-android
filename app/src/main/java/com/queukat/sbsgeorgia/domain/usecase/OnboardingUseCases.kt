...
class LoadOnboardingDocumentPreviewUseCase
@Inject
constructor(
    ...
    suspend operator fun invoke(uriString: String, expectedDocumentType: OnboardingDocumentType) =
...
constructor(
    ...
    suspend operator fun invoke(profile: TaxpayerProfile, config: SmallBusinessStatusConfig) {
        val reminders =
            settingsRepository.observeReminderConfig().first() ?: ReminderConfig(
